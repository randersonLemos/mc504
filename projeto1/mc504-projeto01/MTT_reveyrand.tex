...
\bstctlcite{IEEEexample:BSTcontrol}
  ...
  \author{Randerson Araújo de Lemos, R.A. 103897;
      Victor Lago, R.A. 194784% <-this % stops a space
...
\begin{abstract}
%\boldmath
This document presents the main results derived from the first contact of the authors with the installation of the Operating System (OS) Minux into a virtual machine and with the recompilation kernel process of the OS itself.
\end{abstract}
...
Nevertheless, after 3 or 5 re-installation cycles all problems were resolved and the OS was made ready for the recompilation of the kernel. Appropriated snapshots were taken.
